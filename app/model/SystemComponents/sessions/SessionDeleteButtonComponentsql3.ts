...
export const sessionDeleteButtonComponentsql3 = new Component({
  id: "session-delete-button-sql-3",
  name: "Session Delete Button (sql-3)",
  tags: ["sessions"],
...
`,
  js: ``,
  sql: `DELETE FROM turnusy WHERE id_turnusu = ?`
});
