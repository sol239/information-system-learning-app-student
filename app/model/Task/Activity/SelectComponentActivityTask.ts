...
export class SelectComponentActivityTask implements IActivityTask {
    public Id: string;
    public Title: string;
    ...
    public static fromJson(json: {
        ...
        Description: string;
        TaskComponents: IComponent[];
    }): SelectComponentActivityTask {
        return new SelectComponentActivityTask(json.Id, json.Title, json.Description, json.TaskComponents);
    }
}