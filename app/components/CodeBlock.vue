...
/* Icon button for formatting */ .icon-btn.format-btn.i-lucide-text-initial { font-size:
1.3em; color: #64748b; transition: color 0.2s; }
.icon-btn.format-btn.i-lucide-text-initial:hover { color: #0ea5e9; }
